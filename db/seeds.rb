...
Activity.create({name: "picnic", description: "come join my picnic", user_id: 6, latitude: 37.808674, longitude: -122.409821, address: "Pier 39, San Francisco, CA 94133"})
Activity.create({name: "beach", description: "welcome to my beach party", user_id: 7, latitude: 37.793342, longitude: -122.396492, address: "Drumm Street, San Francisco, CA 94111"})
Activity.create({name: "volleyball", description: "play volleyball together", user_id: 8, latitude: 37.798925, longitude: -122.395119, address: "Pier 7, San Francisco, CA 94111"})
Activity.create({name: "bar", description: "happy hour come join", user_id: 9, latitude: 37.791308, longitude: -122.429092, address:"2151 Laguna Street, San Francisco, CA 94115"})